...
class TestCourseSearchTool:
    ...
    def test_execute_with_both_filters(self, course_search_tool):
        ...
        result = course_search_tool.execute("introduction", course_name="MCP", lesson_number=1)
    ...
    def test_execute_empty_results_with_filters(self, course_search_tool):
        ...
        result = course_search_tool.execute("empty_results", course_name="MCP", lesson_number=1)
    ...
    def test_format_results_with_lesson(self, course_search_tool):
        ...
        results = SearchResults(
            ...
            metadata=[{"course_title": "Test Course", "lesson_number": 5, "chunk_index": 0}],
            distances=[0.1]
        )
