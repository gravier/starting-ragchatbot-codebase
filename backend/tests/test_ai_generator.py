...
class TestAIGenerator:
    ...
    def test_generate_response_without_tools(self, mock_anthropic_client, mock_config, mock_anthropic_response):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_with_tools_no_usage(self, mock_anthropic_client, mock_config, mock_anthropic_response, tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_with_tool_usage(self, mock_anthropic_client, mock_config, mock_anthropic_tool_response, mock_anthropic_final_response, tool_manager):
        """Test response generation with tool usage"""
        mock_client = Mock()
        
        # First call returns tool use response, second call returns final response
        mock_client.messages.create.side_effect = [mock_anthropic_tool_response, mock_anthropic_final_response]
        mock_anthropic_client.return_value = mock_client
        ...
        assert response == "Based on the course materials, MCP (Model Context Protocol) enables AI applications to securely connect to external data sources."
        
        # Should have been called twice (initial + follow-up)
        assert mock_client.messages.create.call_count == 2
    
    @patch('ai_generator.anthropic.Anthropic')
    def test_handle_tool_execution(self, mock_anthropic_client, mock_config, mock_anthropic_tool_response, mock_anthropic_final_response, tool_manager):
        ...
        response = generator._handle_tool_execution(mock_anthropic_tool_response, base_params, tool_manager)
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_sequential_tool_usage(self, mock_anthropic_client, mock_config, mock_anthropic_tool_response, tool_manager):
        ...
        mock_client.messages.create.side_effect = [mock_anthropic_tool_response, second_response, final_response]
        mock_anthropic_client.return_value = mock_client
    ...
    @patch('ai_generator.anthropic.Anthropic') 
    def test_generate_response_max_rounds_enforcement(self, mock_anthropic_client, mock_config, mock_anthropic_tool_response, mock_anthropic_final_response, tool_manager):
        ...
        mock_client.messages.create.side_effect = [mock_anthropic_tool_response, mock_anthropic_tool_response, mock_anthropic_final_response]
        mock_anthropic_client.return_value = mock_client
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_tool_then_direct_response(self, mock_anthropic_client, mock_config, tool_manager):
        ...
        second_response.content = [Mock()]
        second_response.content[0].text = "Based on the search results, here's the answer."
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_context_preservation(self, mock_anthropic_client, mock_config, tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_tool_execution_error_in_sequence(self, mock_anthropic_client):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_conversation_history_included(self, mock_anthropic_client, mock_config, mock_anthropic_response):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tool_execution_error_handling(self, mock_anthropic_client, mock_config, mock_anthropic_tool_response):
        ...
        generator._handle_tool_execution(mock_anthropic_tool_response, base_params, mock_tool_manager)
...
class TestAIGeneratorWithInvalidConfig:
    ...
    def test_invalid_model_name(self, mock_anthropic_client, mock_config):
        ...
        mock_client.messages.create.side_effect = Exception("Invalid model: 1claude-sonnet-4-20250514")
        mock_anthropic_client.return_value = mock_client
        
        generator = AIGenerator(mock_config.ANTHROPIC_API_KEY, "1claude-sonnet-4-20250514")
